...
This design system equips designers and engineers to produce work that feels native to Citrate: deliberate, sturdy, expensive, and government-document precise on the surface, with a quiet biological-cryptographic undercurrent. The audience is procurement and operations leaders at defense_prime, Meridian Chemical, Continental, Gulf Energy, state and federal governments — buyers who must feel the work would survive scrutiny in a contractor's vault, a minister's briefing book, and a SOC.
